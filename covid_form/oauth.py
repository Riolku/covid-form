...
cached_config = requests.get(
    f"https://login.microsoftonline.com/{org_guid}/v2.0/.well-known/openid-configuration"
).json()
...
def get_oauth_uri():
    ...
    return (
        f"https://login.microsoftonline.com/{org_guid}/oauth2/v2.0/authorize?"
        + urlencode(
            dict(
                client_id=client_id,
